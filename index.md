  ...
  <div class="fsa-grid">
    ...
    <div class="fsa-grid__1 fsa-grid__4/12@l fsa-grid__3/12@xl">
      <div class="fsa-level@s fsa-level--none@l fsa-level--grow-auto">
        ...
        <div class="fsa-m-b--s">
          <a href="https://codepen.io/pen?template=WNQdJpp" class="fsa-btn fsa-btn--secondary fsa-btn--block">
            <svg class="fsa-icon fsa-icon--size-2" aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <div class="fsa-m-b--s">
          <a disabled class="fsa-btn fsa-btn--secondary fsa-btn--block">
            ...
            <span>Figma <span class="fsa-show@l">Assets</span> <small class="fsa-font--sans fsa-show@l">Coming soon</small></span>
          </a>
        </div>
      </div>
    </div>
