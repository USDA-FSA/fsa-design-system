  ...
  <div class="ds-combinator__props">
    ...
    <div class="fsa-field ds-combinator__item">
      ...
      <span class="fsa-btn-group fsa-btn-group--fill fsa-btn-group--small" role="group" id="combinatorElement" aria-describedby="combinatorElementLabel">
        <button data-behavior="combinator-btn-group" data-element-type="button" class="fsa-btn-group__item" type="button">Buttons</button>
        <button data-behavior="combinator-btn-group" data-element-type="a" class="fsa-btn-group__item fsa-btn-group__item--active" aria-selected="true" type="button">Links</button>
      </span>
    </div>
    <div class="fsa-field ds-combinator__item">
