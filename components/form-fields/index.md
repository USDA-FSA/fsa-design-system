...
By using `fsa-field--columns` paired with use of the [Grid System]({{ site.baseurl }}grid-and-layout/), you can define a consistant column structure for larger screens, while they will stack on smaller screens (e.g. handheld devices).
