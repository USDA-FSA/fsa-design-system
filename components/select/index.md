  ...
  <div class="ds-combinator__props">
    ...
    <div class="fsa-field ds-combinator__item ds-combinator__item--inline">
      ...
      <label class="fsa-switch ds-combinator__switch">
        <input type="checkbox" class="fsa-switch__checkbox" id="combinatorFill" name="combinatorFill" data-behavior="combinator-toggle-class" value="fsa-select--fill">
...
{% capture rwdURL %}
https://usda-fsa.github.io/fsa-style/demo/rwd__select.html
{% endcapture %}
...
* Avoid using the  `multiple` attribute, use the [Select Multi component]({{ site.baseurl }}components/select-multi/) instead. Users often don’t understand how to select multiple items from the `select` element (by holding down a modifier key).
* For site navigation.
{% endcapture %}
